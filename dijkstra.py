  ...
  def print_solution(self, start_vertex, distances, parents, node_map):
    ...
    for vertex_index in range(n_vertices):
      if vertex_index != start_vertex:
        ...
        self.print_path(vertex_index, parents, node_map)


  # Function to print shortest path
  # from source to current_vertex
  # using parents array
  def print_path(self, current_vertex, parents, node_map):
    # Base case : Source node has
    # been processed
    if current_vertex == NO_PARENT:
      return
    self.print_path(parents[current_vertex], parents, node_map)
